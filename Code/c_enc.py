def c_enc():
    while True:
        ...
        if choice == "1":
            ...
            with open(r"plugins\c_enc_RSA\c_enc_folder_1.py", "r", encoding="utf-8") as f:
                template = f.read()
            ...
            file_name = input("程序文件名称(不需要后缀!): ")
            file_path_2 = f"{file_path}/{file_name}.py"
            with open(r"plugins\c_enc_RSA\c_enc_file_1.py", "r", encoding="utf-8") as f:
            ...
            file_name = input("程序文件名称(不需要后缀!): ")
            file_path_2 = f"{file_path}/{file_name}.py"
            with open(r"plugins\c_enc_RSA\c_enc_decrypt.py", "r", encoding="utf-8") as f:
                c_enc_decrypt = f.read()
            with open(file_path_2, "w", encoding="utf-8") as f:
